...
export const PROFESSIONS = [
  ...
  'GP with Mental Health Interest',
  'Paediatrician',
  'Developmental Paediatrician',
  'Psychiatrist',
  'Child and Adolescent Psychiatrist',
  'Old Age Psychiatrist (Psychogeriatric)',
  ...
  // Community, Cultural and Peer Support
  ...
  'Alcohol and Other Drug (AOD) Clinician',
  ...
  'Perinatal and Parenting Mental Health Service',
  ...
  'Multidisciplinary Mental Health Clinic',
  'Private Mental Health Clinic',
  'Community Health Organisation',
  'Not-for-profit Mental Health Organisation',
  // General
