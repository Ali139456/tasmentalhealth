...
export function CrisisSupport() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-primary-50/30 to-gray-50">m\
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
                        ...
                        {safetyPlan[section.key].map((item, index) => (
                          <div key={item.id} className="flex items-center gap-2 sm:gap-3 bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
                            ...
                            <button
                              ...
                              className="p-1.5 sm:p-2 text-terracotta hover:bg-terracotta-50 rounded-lg transition-colors flex-shrink-0"
                            >
        ...
        {activeTab === 'find-help' && (
          <div className="max-w-6xl mx-auto space-y-8 sm:space-y-10">
            ...
            <div className="relative bg-terracotta text-white rounded-xl p-5 sm:p-6 text-center shadow-xl overflow-hidden">
              {/* Background Pattern */}
              <div className="absolute inset-0 opacity-10">
              ...
              <div className="relative z-10">
                ...
                <a
                  href="tel:000"
                  className="inline-flex items-center gap-2 px-6 py-2.5 bg-white text-terracotta rounded-lg font-bold text-base hover:bg-gray-50 transition-all transform hover:scale-105 shadow-lg"
                >
                  <Phone className="w-5 h-5" />
                  Call 000 Now
                </a>
                      ...
                      <div key={idx} className="bg-gray-50 rounded-lg p-4 sm:p-5 border border-gray-200 hover:border-primary-300 transition-colors">
                        ...
                        <div className="flex gap-2">
                          <a
                            ...
                            className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-terracotta text-white rounded-lg hover:bg-terracotta-600 transition-colors text-xs font-semibold shadow-md"
                          >
                ...
                <div className="mt-8 sm:mt-10 bg-white rounded-xl p-8 sm:p-12 border-2 border-gray-200 shadow-lg text-center">
                  ...
                  <div className="bg-primary-50 rounded-xl p-6 border border-primary-200">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      ...
                      <a
                        href="tel:000"
                        className="px-6 py-3 bg-terracotta text-white rounded-lg hover:bg-terracotta-600 transition-all font-semibold shadow-md"
                      >
                        Emergency: 000
                      </a>
                    </div>
