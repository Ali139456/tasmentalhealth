...
export function CrisisSupport() {
  ...
  const stateData: Record<string, {
    ...
    TAS: {
      ...
      hospitals: [
        { name: 'Royal Hobart Hospital', location: 'Hobart', phone: '(03) 6166 8308', address: '48 Liverpool St, Hobart TAS 7000', service: '24/7 Emergency' },
        { name: 'Launceston General Hospital', location: 'Launceston', phone: '(03) 6777 6777', address: '274-280 Charles St, Launceston TAS 7250', service: '24/7 Emergency' },
        { name: 'North West Regional Hospital', location: 'Burnie', phone: '(03) 6430 6000', address: '23 Brickport Rd, Burnie TAS 7320', service: '24/7 Emergency' },
        { name: 'Mersey Community Hospital', location: 'Latrobe', phone: '(03) 6478 5000', address: 'Torquay Rd, Latrobe TAS 7307', service: '24/7 Emergency' }
      ]
    },
    VIC: {
      crisisLines: [
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 lg:p-12 mb-6 sm:mb-8">
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-6 sm:mb-8">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary-100 rounded-xl flex items-center justify-center flex-shrink-0">
