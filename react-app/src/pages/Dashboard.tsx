      ...
      <div className="py-12 px-4 relative z-10">
        <div className="container mx-auto max-w-6xl">
          ...
          {user && emailVerified === false && (
            <div className="mb-6 bg-terracotta-50 border-2 border-terracotta-400 rounded-xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <AlertCircle className="w-6 h-6 text-terracotta" />
                <div>
                  <p className="font-semibold text-terracotta-800">Email Verification Required</p>
                  <p className="text-sm text-terracotta-700">Please verify your email address to access all features.</p>
                </div>
              </div>
              <button
                onClick={async () => {
                ...
                className="px-4 py-2 bg-terracotta text-white rounded-lg hover:bg-terracotta-600 transition-colors text-sm font-semibold"
              >
                Resend Email
              </button>
            </div>
          ...
          {/* Subscription Status */}
          {subscription && (
            <div className="bg-terracotta text-white rounded-2xl p-6 mb-8 shadow-xl border-2 border-terracotta-300">
            <div className="flex items-center justify-between">
              ...
              <button 
                ...
                className="px-4 py-2 bg-white text-terracotta rounded-lg font-semibold hover:bg-terracotta-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {processingPortal ? (
                  <>
                  ...
                  {listings
                    ...
                    .map(listing => (
                      <button
                        ...
                        className="px-6 py-3 bg-white text-terracotta rounded-lg font-semibold hover:bg-terracotta-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                      >
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          {listing.is_featured && (
                            <span className="inline-flex items-center px-2 py-1 bg-terracotta-100 text-terracotta-800 rounded text-xs font-semibold">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      ...
                      {listing.status === 'approved' && !listing.is_featured && (
                        <button 
                          onClick={() => handleTierSelection(listing.id)}
                          disabled={processingListingId === listing.id}
                          className="px-4 py-2 bg-terracotta text-white rounded-lg hover:bg-terracotta-600 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                        >
                          {processingListingId === listing.id ? (
                            <>
                  ...
                  {avatarPreview && (
                    <div className="relative w-32 h-32 rounded-xl overflow-hidden border-2 border-primary-200">
                      ...
                      <button
                        ...
                        className="absolute top-1 right-1 p-1 bg-terracotta text-white rounded-full hover:bg-terracotta-600 transition-colors"
                      >
